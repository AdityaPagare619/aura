//! Policy & Ethics Wiring Integration Tests
//!
//! Validates that the policy gate, TRUTH framework, anti-sycophancy guard,
//! manipulation detection, audit logging, and emergency stop system are
//! correctly wired into the daemon's execution and response paths.
//!
//! These tests exercise the **wiring** (i.e. that subsystems are called
//! and their outputs routed correctly), not the internals of each subsystem.
